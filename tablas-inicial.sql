...
--
-- Table structure for table `Libro2`
--
...
--
-- Dumping data for table `Libro2`
--

LOCK TABLES `Libro2` WRITE;
/*!40000 ALTER TABLE `Libro2` DISABLE KEYS */;
INSERT INTO `Libro2` VALUES (1,'Yo, Robot','Gnome Press',374,1),
...
/*!40000 ALTER TABLE `Libro2` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `Usuario2` VALUES (1,'Ricardo','Torres',46,'H','Unidad de los Patos, Candelaria'),(2,'Tony','Stark',45,'H','Stark Tower'),(3,'Black','Widow',30,'M','Unidad de los Patos, Candelaria'),(4,'Cap','America',200,'H','Desconocida');
